...
# pandoc --from markdown+hard_line_breaks --output docs/baseline_model_report.pdf docs/baseline_model_report.md
---

# Random sampler model
...
# Random forest model
We runned also a random forest classifier.
